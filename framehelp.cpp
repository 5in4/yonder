...
void FrameHelp::showAbout() {
    ...
    QMessageBox::about(this, tr("About Yonder"), tr("<b>%1 %2</b><p>&copy; 2011-2012 by %3</p><p><a href=\"%4\">%4</a></p><p><i>Running with:</i><br />Qt %5,<br />taglib %6.%7</p><p><i>Audio engine:</i><br />FMOD Sound System by Firelight Technologies</p><br /><img src=\":/application/qt-logo.svg\" /><img src=\":/application/fmod-logo.svg\" />").arg(NAME, VERSION, AUTHOR, WEBADDRESS, QT_VERSION_STR, QString("%1").arg(TAGLIB_MAJOR_VERSION), QString("%1").arg(TAGLIB_MINOR_VERSION)));
}
